    ...
    <div>
      <div className="h-[146px] flex flex-col items-center justify-center">
        ...
        <p className="flex flex-col items-center">
          <Link href={'/'} className="font-normal text-base text-[#121115] flex items-center space-x-3">
      ...
      <button
        className="w-full h-[54px] rounded-b-xl bg-success-500 text-white font-bold text-lg"
        onClick={() => {
          Router.push('/builder');
        }}
      >
