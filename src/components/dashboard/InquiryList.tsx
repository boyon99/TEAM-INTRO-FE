      ...
      {data ? (
        <>
          ...
          <div className="px-[15px]">
            <section className="flex items-center border-b border-b-GrayScalePrimary-200 w-full h-[54px] pl-4">
              <Checkbox checked={allSelected} handleClick={toggleAllSelected} />
              <span className="text-[15px] text-GrayScaleNeutral-1000 mx-20">이메일</span>
              <span className="text-[15px] text-GrayScaleNeutral-1000 ml-[18px]">이름</span>
              <span className="text-[15px] text-GrayScaleNeutral-1000 mx-[120px]">내용</span>
              <span className="text-[15px] text-GrayScaleNeutral-1000 ml-2">구분</span>
            ...
            {rows.map((el) => (
              <div key={el.contact_us_log_id}>
                <section className="h-[68px] flex items-center w-full pl-4">
                  <Checkbox checked={el.selected} handleClick={() => toggleRow(el.contact_us_log_id)} />
                  <article onClick={openDetailModal} className="cursor-pointer flex items-center">
                    <p className="text-[14px] text-GrayScalePrimary-800 mx-10 text-center truncate w-[130px]">
                      {el.email}
                    </p>
                    <p className="text-[14px] text-GrayScalePrimary-800 text-center truncate w-10">{el.name}</p>
                    <p className="text-[14px] text-GrayScalePrimary-800 ml-16 mr-9 text-center truncate w-[150px]">
                      {el.content}
                    </p>
                    <p className="text-[14px] text-GrayScalePrimary-800 text-center truncate w-[70px]">{el.type}</p>
                    <span className="mx-10 text-[14px] text-GrayScalePrimary-800">{el.date}</span>
                  </article>
                  <PrimaryButton
                    text="확인"
