...
interface InputProps {
  ...
  export default function Input({
    ...
    return (
      <>
        {size === "large" ? (
        <div className={cls(name === "register_password" || name === "register_password_check" || name === "snsemail" || name === "findid_email" || name === "findbznum_email" || name === "findid_pass" || name === "findemail_pass" || name === "repass" || name === "old_repass" || name === "repass_check"? "" : "flex flex-col items-start gap-[8px] p-0 justify-center mb-5" )}>
            <span className={cls("w-[64px] h-[16px] font-bold text-[16px]/[100%] text-GrayScalePrimary-800", name === "register_password" ? "mr-[71.93px]": "", name === "register_password_check"? "mr-[36px]": "", name === "snsemail" ?  "mr-[95px]":"", name === "findid_email" ? "mr-[20px]":"", name === "findbznum_email" ? "mr-[10px]" : "",
             name === "findid_pass" ? "mr-[36px]": "", name === "findemail_pass" ? "mr-[36px]": "",name === "repass" ? "mr-[62px]" : "", name === "old_repass" ? 'mr-[47px]':'', name === "repass_check" ? "mr-[26px]" : "")}>{label}</span>
