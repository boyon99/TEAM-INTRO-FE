...
export function ProductTitle({ onClick, deleteSelectedClick, handleCheckboxChange, selectedItems, setSelectedItems, TeamAddonClick,teamHandleChange,teamselectedItems,setTeamSelectedItems, NewsAddonClick, HistoryAddonClick  }: any) {
  const { products, setProducts, teammembers, setTeamMember } = useStore();
      ...
      return (
        ...
        <div className="w-[264px] mt-[32px] flex">
          ...
          <button onClick={TeamAddonClick? TeamAddonClick : NewsAddonClick? NewsAddonClick:HistoryAddonClick? HistoryAddonClick : onClick} className="w-[120px] h-[36px] flex bg-[#4b48df] items-center justify-center rounded-lg p-[12px_16px_12px_12px] text-[#fff]">+ 추가하기</button>
          </div>
          ...
          <div className="mt-[20px]">
            ...
            //  setTeamSelectedItems(arrayMove(teamselectedItems, oldIndex, newIndex));
           }}
