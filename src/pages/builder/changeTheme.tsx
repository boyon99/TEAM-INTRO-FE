    ...
    <div className="ml-[28px]">
      ...
      >
        <img
          src="/ThemeA.png"
          alt="ThemeA"
          className="w-[252px] h-[auto] ml-[4px]"
        />
      </button>
      <button
        className={
      ...
      <div className="mt-[48px] font-[700] text-[18px] text-GrayScalePrimary-700">
        기본 색상 변경
      </div>
      {/* 색상 선택 */}
      <div className="w-[264px] h-[42px] rounded-[6px] border-[2px] border-GrayScalePrimary-300 mt-[8px] flex py-[7px]">
        <div
          className="rounded-[6px] w-[26px] h-[24px] ml-[12px] mt-[1px]"
          style={{ backgroundColor: theme.color }}
        />
        <span className="ml-[14px] font-[400] text-[18px] tracking-[1px]">
          {theme.color}
        </span>
      </div>
      <div className="text-GrayScalePrimary-600 font-[400] text-[12px] w-[256px] mt-[16px]">
        회사 로고를 구성하는 색상, 대표 이미지에서 추출할 수 있는 색상을
        선택하는 것을 추천드립니다.
      </div>
      <PrimaryButton
        type="white"
