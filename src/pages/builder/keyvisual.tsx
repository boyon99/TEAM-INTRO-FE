...
function Preview() {
  const { widgets, setToggle, keyVisual } = useStore();
  return (
      ...
      {widgets[0].toggle ? (
        <>
          ...
          <BuilderUploadImage
            title="배경 이미지"
            ratio={1280 / 630}
            imgSrc={keyVisual.bgImg}
            setImgSrc={keyVisual.setBgImg}
          />
          ...
          <label>
            <input
              ...
              onChange={() => keyVisual.setFilter('Black')}
          ...
          <label className="mr-4">
            <input
              ...
              onChange={() => keyVisual.setFilter('White')}
        ...
        예: 회사와 회사 간의 연결로 서로 성장 할 수 있도록 합니다. "
            id="businessNumber"
            value={keyVisual.sloganDetail}
            setValue={keyVisual.setSloganDetail}
          />
          <div className="text-GrayScalePrimary-600 font-[400] text-[12px] w-[256px] mt-[8px] pl-[2px]">
