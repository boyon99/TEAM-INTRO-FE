...
function Preview() {
  ...
  return (
    <div className="ml-[28px]">
      ...
      <BuilderInput title="회사 이름" type="text" placeholder="예: 질링스" id="companyName" />
      <BuilderInput title="설립일" type="text" placeholder="2018-03-15" id="establishmentDate" />
      <BuilderInput title="대표 성명" type="text" placeholder="예: 성이름" id="representativeName" />
